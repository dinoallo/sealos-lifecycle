...
const (
	...
	TestDistributionControllerImageName   = Prefix + "DISTRIBUTION_CONTROLLER_IMAGE_NAME"
	TestDistributionControllerImageTar    = Prefix + "DISTRIBUTION_CONTROLLER_IMAGE_TAR"
	TestDistributionControllerManifestDir = Prefix + "DISTRIBUTION_CONTROLLER_MANIFEST_DIR"
