...
- `docs/architecture/package-format.md`
...
| `docs/plans/minimal-k8s-poc.md` | Update the PoC doc once OCI render is proven so local package dirs are no longer the only documented path. |
