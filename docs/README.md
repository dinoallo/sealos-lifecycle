...
| [Controller fleet observability](./guides/controller-fleet-observability.md) | Defines target aggregation, rollout progress, health evidence, promotion gates, and failure archives for controller fleets. Chinese: [zh-CN](./guides/controller-fleet-observability.zh-CN.md). |
