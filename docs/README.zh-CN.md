...
5. 使用 [Controller install](./guides/controller-install.md)、[BOM and channel](./guides/bom-and-channel.md)、[Local repo and secret](./guides/local-repo-and-secret.md) 和 [Sync drift](./guides/sync-drift.md) 完成操作流程。
